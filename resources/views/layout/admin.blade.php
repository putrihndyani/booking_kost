...
<head>
    ...
    <link rel="stylesheet" href="{{ url('admin/assets/css/atlantis.min.css') }}">
...
<body>
                    ...
                    <ul class="nav nav-primary">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="sidebarLayouts">
                                <ul class="nav nav-collapse">
                                    <li>
                                        <a href="{{ url('datakamar') }}">
                                            <span class="sub-item">Data kamar</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ url('tipekamar') }}">
                                            <span class="sub-item">Tipe kamarr</span>
                                        </a>
                                    </li>
                        ...
                        <li class="nav-item">
                            <a data-toggle="collapse" href="{{ url('bookingkamar') }}">
                                ...
                                <ul class="nav nav-collapse">
                                    ...
                                    <li>
                                        <a href="tables/datatables.html">
                                            <span class="sub-item">Bukti Transaksi</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
    ...
    <!-- Atlantis JS -->
    <script src="{{ url('admin/assets/js/atlantis.min.js') }}"></script>
